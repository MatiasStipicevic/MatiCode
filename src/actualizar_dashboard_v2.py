...
<div class="sec-sub">
  D&iacute;as = Hoy &minus; <b>Fecha fin real</b> del &uacute;ltimo contrato &mdash;
  usa <code>fecha_termino_real</code> si existe, si no <code>fecha_fin</code> &mdash;
    ...
    <table id="vac-unit-table">
      <thead>
        <tr>
          ...
          <th style="text-align:left">Proyecto</th>
          <th style="text-align:center">Fecha fin real <span style="font-weight:400;color:#B0BAC8;font-size:.6rem">(base del cálculo)</span></th>
...
function vacSetProj(proj, grp) {{
  ...
  withHist.forEach(function(u) {{
    ...
    var reservBadge = u.r
      ...
      : '';
    // Fecha fin real: fecha_termino_real si existe, si no fecha_fin
    var fechaLabel = u.f
      ? '<span style="font-weight:600;color:#1A2332">'+u.f+'</span>'
      : '<span style="color:#8896A6">—</span>';
    if(u.fc && u.f && u.fc !== u.f)
      fechaLabel += '<div style="font-size:.67rem;color:#8896A6;margin-top:2px">'
